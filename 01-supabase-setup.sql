-- ============================================================
-- DECOR DESIGN — CONFIGURACIÓN COMPLETA DE SUPABASE
-- Ejecutar UNA VEZ en: Supabase > SQL Editor > New query > Run
-- Es seguro volver a ejecutarlo: no borra tus datos existentes.
-- ============================================================
...
-- El público ve únicamente contenido activo. El administrador ve todo.
...
-- Solo administradores autorizados pueden modificar contenido.
...
create policy "Admin reads own authorization"
on public.admin_users for select
to authenticated
using (user_id = auth.uid());

-- Permisos API; RLS continúa siendo la protección real.
...
-- ---------- Storage público para fotografías ----------
...
-- El bucket es público únicamente para visualizar imágenes.
-- Cargar, cambiar o eliminar archivos requiere ser administrador.
...
-- ---------- Categorías iniciales (sin duplicarlas) ----------
...
-- Si ves “Success. No rows returned”, la configuración terminó correctamente.
